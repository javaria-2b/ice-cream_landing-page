...
const toppings = [
    { id: '1', name: 'Sprinkles', image: '/sprinkles.png', price: 50, isAvailable: true },
    { id: '2', name: 'Chocolates', image: '/chocolates.png', price: 50, isAvailable: true },
    { id: '3', name: 'brownie', image: '/brownie.png', price: 50, isAvailable: true },
];
